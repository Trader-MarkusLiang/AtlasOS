...
| Gate 5 | Portfolio Impact | What happens to capital and position state? | Position lifecycle, source of funds, sizing implication, and concentration risk are reviewed. | Real portfolio impact is unknown or private data would need to enter Git. |
